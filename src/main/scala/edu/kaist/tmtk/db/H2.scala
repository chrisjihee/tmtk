...
class H2(path: String, var table: String = null, var schema: String = null, user: String = null, pswd: String = null, reset: Boolean = false, lv: AnyRef = "I") extends Closeable {
  val connection = DriverManager.getConnection(s"jdbc:h2:$path", user, pswd)
  ...
  override def toString = s"H2($path/${table.asStr("")})"
